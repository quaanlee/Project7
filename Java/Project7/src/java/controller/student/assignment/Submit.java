...
public class Submit extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (account == null) {
            ...
            request.getRequestDispatcher("views/role/student/assignment/SubmitView.jsp").forward(request, response);
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(rd.submit(team.getId(), category, file)){
            response.sendRedirect("assignmentC");
        } else {
            request.setAttribute("category", category);
            request.setAttribute("checkSubmit", "Submit not successful");
            request.getRequestDispatcher("views/role/student/assignment/SubmitView.jsp").forward(request, response);
        }
    }
