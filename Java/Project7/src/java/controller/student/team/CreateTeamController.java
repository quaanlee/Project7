...
public class CreateTeamController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (email == null) {
            ...
            request.getRequestDispatcher("views/role/student/teamm/CreateTeam.jsp").forward(request, response);
        }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (nameTeam == null || nameTeam.isBlank()) {
            ...
            request.getRequestDispatcher("views/role/student/teamm/ComfimeCreateTeam.jsp").forward(request, response);
        }
    }
