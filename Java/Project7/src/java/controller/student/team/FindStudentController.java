...
package controller.student.team;
...
public class FindStudentController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet FindStudentController</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet FindStudentController at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        List<Student> stList = stDao.getStudentsById(stId);
      
        request.setAttribute("student", stDao.getStudentByEmail(email));
        request.setAttribute("stList", stList);
        request.setAttribute("input", stId);
        //...
        ...
        if(mitd.checkMemberInTeam(email)){ 
            ...
            //
            List<Student> memList = mitd.getAllMember(team.getId());
