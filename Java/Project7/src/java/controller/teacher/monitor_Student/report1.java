...
public class report1 extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet report1</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet report1 at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        List<Report> rL = new ReportDAO().getSubmittedList(teacher.getId(), "Report 1");
        List<ReportMark> rmL = new ArrayList<>();
        for (Report r : rL) {
            rmL.add(new ReportMark(r, new MarkTeamDAO().checkNullMark(r.getTeamId(), "Report 1")));
        }
        ...
        request.setAttribute("category", "Report 1");
