 ...
 * @author LENOVO
 */
public class final_report extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet final_report</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet final_report at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        List<Report> rL = new ReportDAO().getSubmittedList(teacher.getId(), "FinalReport");
        List<ReportMark> rmL = new ArrayList<>();
        for (Report r : rL) {
            rmL.add(new ReportMark(r, new MarkTeamDAO().checkNullMark(r.getTeamId(), "FinalReport")));
        }
        ...
        request.setAttribute("category", "FinalReport");
