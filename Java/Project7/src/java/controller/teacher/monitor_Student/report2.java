...
public class report2 extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet report2</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet report2 at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        List<Report> rL = new ReportDAO().getSubmittedList(teacher.getId(), "Report 2");
        List<ReportMark> rmL = new ArrayList<>();
        for (Report r : rL) {
            rmL.add(new ReportMark(r, new MarkTeamDAO().checkNullMark(r.getTeamId(), "Report 2")));
        }
        ...
        request.setAttribute("category", "Report 2");
