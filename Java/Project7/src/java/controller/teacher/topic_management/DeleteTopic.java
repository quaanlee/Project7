...
public class DeleteTopic extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (account == null) {
            ...
            request.getRequestDispatcher("views/role/teacher/topic_management/DeleteTopic.jsp").forward(request, response);
        }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        } else if (option != null && option.equals("Yes")) {
            if (new TopicDAO().deleteTopicById(topicId)) {
                response.sendRedirect("myTopic");
            } else {
                request.setAttribute("notif", "Delete not successful");
                request.getRequestDispatcher("views/role/teacher/topic_management/DeleteTopic.jsp").forward(request, response);
            }
        }
    }
