...
public class EditTopic extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (account == null) {
            ...
            Topic topic = td.getTopicById(idTopic);
            request.setAttribute("topic", topic);
            
            request.getRequestDispatcher("views/role/teacher/topic_management/EditTopic.jsp").forward(request, response);
        }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String idTopic = request.getParameter("topicId");
        if (new TopicDAO().editTopicById(idTopic, topicName, status)) {
        ...
        Topic topic = td.getTopicById(idTopic);
        request.setAttribute("topic", topic);
        request.setAttribute("notif", "Edit not successful");
        request.getRequestDispatcher("views/role/teacher/topic_management/EditTopic.jsp").forward(request, response);
    }
